...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/matheus/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').default({tool: 'webpack', checkSum: '205ebce2a25bae1779afd6AEtbWksFW1ADVFQBAwMOCwUHVwcF', mode: 'build'}); } catch(cjsError) { try { import('file:///home/matheus/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '205ebce2a25bae1779afd6AEtbWksFW1ADVFQBAwMOCwUHVwcF', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
